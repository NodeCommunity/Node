...
In order to support loading of multiple wallets in node-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is node.cpp.
...
Changes to node.cpp
----------------------
node.cpp is the entry point into node-qt, and as such, will require some minor modifications to provide hooks for
