...
Intro
-----
Node (NOD) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Node utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run node-qt.exe.

Node Core is the original Node client and it builds the backbone of the network.
However, it downloads and stores the entire history of Node transactions;
