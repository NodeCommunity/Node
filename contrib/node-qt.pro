...
RESOURCES += src/qt/node.qrc src/qt/node_locale.qrc

TRANSLATIONS += src/qt/locale/node_bg.ts \
                src/qt/locale/node_de.ts \
                src/qt/locale/node_en.ts \
                src/qt/locale/node_es.ts \
                src/qt/locale/node_fi.ts \
                src/qt/locale/node_fr.ts \
                src/qt/locale/node_it.ts \
                src/qt/locale/node_ja.ts \
                src/qt/locale/node_pl.ts \
                src/qt/locale/node_pt.ts \
                src/qt/locale/node_ru.ts \
                src/qt/locale/node_sk.ts \
                src/qt/locale/node_sv.ts \
                src/qt/locale/node_vi.ts \
                src/qt/locale/node_zh_CN.ts \
                src/qt/locale/node_zh_TW.ts
