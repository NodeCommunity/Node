...
#   c) node1 mines 32 blocks, so now node 0 has 500000NOD, node 1 has 4250NOD, node2 has none.
#   d) node0 sends 601 NOD to node2, in two transactions (301 NOD, then 300 NOD).
