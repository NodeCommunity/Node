...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Node features */
        {"node", "masternode", &masternode, true, true, false},
        {"node", "listmasternodes", &listmasternodes, true, true, false},
        {"node", "getmasternodecount", &getmasternodecount, true, true, false},
        {"node", "masternodeconnect", &masternodeconnect, true, true, false},
        {"node", "masternodecurrent", &masternodecurrent, true, true, false},
        {"node", "masternodedebug", &masternodedebug, true, true, false},
        {"node", "startmasternode", &startmasternode, true, true, false},
        {"node", "createmasternodekey", &createmasternodekey, true, true, false},
        {"node", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"node", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"node", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"node", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"node", "getmasternodescores", &getmasternodescores, true, true, false},
        {"node", "mnbudget", &mnbudget, true, true, false},
        {"node", "preparebudget", &preparebudget, true, true, false},
        {"node", "submitbudget", &submitbudget, true, true, false},
        {"node", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"node", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"node", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"node", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"node", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"node", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"node", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"node", "checkbudgets", &checkbudgets, true, true, false},
        {"node", "mnsync", &mnsync, true, true, false},
        {"node", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> node-cli " + methodname + " " + args + "\n";
}
