                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Node Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NOD address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and node: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Node Core"), this);
    aboutAction->setStatusTip(tr("Show information about Node Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Node"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NOD addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NOD addresses"));
    ...
    openAction->setStatusTip(tr("Open a node: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Node Core help message to get a list with possible Node command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Node Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Node network", "", count));
}
...
{
    QString strTitle = tr("Node Core"); // default title
